...
print("="*60)
print(f"SMART HOME PATTERN RECOGNITION SYSTEM")
...
# Room mappings:
# - Dining Room = hall_center_alarm
# - Kid's Room = hall_end_alarm
# ============================================================================

CONSTRAINTS = {
    "forbidden": [
        # No direct Bedroom → Kitchen (must pass through Dining Room)
        ["LA:sn_linearalarm_bedroom:activated", "LA:sn_linearalarm_kitchen:activated",
         "required_between", "AA:hall_center_alarm:activated"],
        
        # No Kid's Room → TV Room without Bathroom
        ["AA:hall_end_alarm:activated", "LA:sn_linearalarm_tvroom:activated",
         "required_between", "LA:sn_linearalarm_bathroom:activated"]
    ],
    "mandatory": [
        # Entrance → Kitchen requires Dining Room first
        ["LA:entrance_start:activated", "LA:sn_linearalarm_kitchen:activated",
         "requires_before", "AA:hall_center_alarm:activated"],
        
        # TV Room requires prior Dining Room
        ["LA:sn_linearalarm_tvroom:activated", "AA:hall_center_alarm:activated"]
    ],
    "temporal": [
        {
            "pair": ["LA:sn_linearalarm_bathroom:activated", "AA:hall_end_alarm:activated"],
            "max_seconds": 30
        },
        {
            "pair": ["AA:hall_center_alarm:activated", "LA:sn_linearalarm_tvroom:activated"],
            "max_seconds": 60
        }
    ],
    "hard_negatives": [
        {"invalid": "LA:entrance_start:deactivated", "requires_before": "LA:entrance_start:activated"}
    ]
}
...
FILIPPOS_PATTERNS = {
    "pattern1": [
        "LA:entrance_start:activated",
        "AA:entrance_alarm:activated",
        "AA:hall_center_alarm:activated",  
        "LA:sn_linearalarm_bathroom:activated",
        "SW:switch_bathroom:on",
        "L:light_bathroom:on",
        "LA:sn_linearalarm_bedroom:activated",
        "SW:switch_bedroom:on",
        "L:light_bedroom:on",
        "LA:sn_linearalarm_kitchen:activated",
        "SW:switch_kitchen:on",
        "L:light_kitchen:on",
        "LA:sn_linearalarm_tvroom:activated",
        "SW:switch_tvroom:on",
        "L:light_tvroom:on"
    ],
    "pattern2": [
...
def create_compact_detection_report():
    ...
    header_text = fig.text(0.5, 0.96, 'SMART HOME PATTERN RECOGNITION', 
...
TOPICS = [
    # Linear alarms
    f"streamsim.{UID}.world.world.sensor.alarm.linear_alarm.entrance_start.data",
    f"streamsim.{UID}.world.world.sensor.alarm.linear_alarm.sn_linearalarm_kitchen.data",
    f"streamsim.{UID}.world.world.sensor.alarm.linear_alarm.sn_linearalarm_bedroom.data",
    f"streamsim.{UID}.world.world.sensor.alarm.linear_alarm.sn_linearalarm_tvroom.data",
    f"streamsim.{UID}.world.world.sensor.alarm.linear_alarm.sn_linearalarm_bathroom.data",
    
    # Area alarms
    f"streamsim.{UID}.world.world.sensor.alarm.area_alarm.entrance_alarm.data",
    f"streamsim.{UID}.world.world.sensor.alarm.area_alarm.hall_center_alarm.data",
    f"streamsim.{UID}.world.world.sensor.alarm.area_alarm.hall_end_alarm.data",
    
    # Switches
    f"streamsim.{UID}.world.world.actuator.switch.relay.switch_kitchen.state",
    f"streamsim.{UID}.world.world.actuator.switch.relay.switch_bedroom.state",
    f"streamsim.{UID}.world.world.actuator.switch.relay.switch_tvroom.state",
    f"streamsim.{UID}.world.world.actuator.switch.relay.switch_bathroom.state",
    
    # Lights
    f"streamsim.{UID}.world.world.actuator.visual.leds.light_kitchen.state",
    f"streamsim.{UID}.world.world.actuator.visual.leds.light_bedroom.state",
    f"streamsim.{UID}.world.world.actuator.visual.leds.light_tvroom.state",
    f"streamsim.{UID}.world.world.actuator.visual.leds.light_bathroom.state",
    f"streamsim.{UID}.world.world.actuator.visual.leds.light_entrance.state",
    f"streamsim.{UID}.world.world.actuator.visual.leds.light_hall_center.state",
    f"streamsim.{UID}.world.world.actuator.visual.leds.light_hall_end.state",
