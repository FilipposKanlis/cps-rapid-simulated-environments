...
- Locsys UID:Each Locsys user receives a unique `UID` generated by the Locsys deployment system when launching a simulation.
This value is environment-specific and **must be replaced with your own UID** inside the scripts before running them.
